  ...
  "inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-medium mx-4 my-2 transition-all",
  {
    variants: {
      variant: {
        ...
        warning: "bg-yellow-100 text-yellow-800 dark:bg-yellow-700/20 dark:text-yellow-300",
        neutral: "bg-gray-100 text-gray-800 dark:bg-gray-700/30 dark:text-gray-300",
      },
    },
    defaultVariants: {
      variant: "default",
...
export default function Tag({
  ...
  className,
  ...props
}: React.ComponentProps<"div"> & VariantProps<typeof tagVariants> & { asChild?: boolean }) {
